...
export default function DashboardLayout() {
  ...
  // Derived state (antes do SidebarContent para evitar closure frágil)
    ...
    <>
      ...
      {publicUrl && (
        <div className="p-4 border-t border-gray-800">
          <a
            ...
            className="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium text-violet-300 hover:bg-violet-300/10 hover:text-violet-200 transition group"
          >
      ...
      <div className="p-4 border-t border-gray-800">
        <div className="flex items-center gap-3 mb-3">
          <div className="w-9 h-9 rounded-full bg-violet-300 flex items-center justify-center text-white text-sm font-semibold flex-shrink-0">
    ...
    <div className="min-h-screen bg-gray-100 flex">
      ...
      <div className="flex-1 min-w-0 flex flex-col">
        ...
        <header className="md:hidden sticky top-0 z-30 bg-white border-b border-gray-200 px-4 py-3 flex items-center justify-between">
          ...
          <Link to="/admin" className="flex items-center gap-2">
            <div className="w-8 h-8 rounded-lg bg-violet-300 flex items-center justify-center">
