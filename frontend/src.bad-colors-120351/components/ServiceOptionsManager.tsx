      ...
      <div className="flex items-start justify-between gap-3 mb-5">
        ...
        {!showForm && (
          <button
            type="button"
            onClick={openCreate}
            className="inline-flex items-center gap-1.5 bg-violet-300 text-white px-3 py-2 rounded-lg text-sm font-medium hover:bg-violet-300 transition whitespace-nowrap flex-shrink-0"
          >
        ...
        >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <div>
              ...
              <input
                ...
                className="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-violet-300 focus:border-transparent transition"
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-violet-300 focus:border-transparent transition resize-none"
              rows={2}
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-9 pr-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-violet-300 focus:border-transparent transition"
          ...
          <div className="flex items-center justify-between p-3 bg-white rounded-lg border border-gray-200 gap-3">
            ...
            <label className="relative inline-flex items-center cursor-pointer flex-shrink-0">
              ...
              />
              <div className="w-11 h-6 bg-gray-300 peer-checked:bg-violet-300 rounded-full transition"></div>
          ...
          <div className="flex flex-col sm:flex-row gap-2 pt-1">
            ...
            <button
              type="submit"
              disabled={saving}
              className="flex-1 bg-violet-300 text-white py-2 rounded-lg text-sm font-medium hover:bg-violet-300 disabled:opacity-60 disabled:cursor-not-allowed transition inline-flex items-center justify-center gap-2"
            >
              {saving ? (
                <>
              ...
              <div className="p-3">
                ...
                <div className="flex items-center gap-1 pt-2 border-t border-gray-100">
                  ...
                  <button
                    ...
                    title="Editar"
                    className="p-1.5 rounded-lg text-violet-300 hover:bg-violet-50 transition"
                  >
