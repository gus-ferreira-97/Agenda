...
export default function TrialBlockedScreen() {
  ...
  const whatsapp = import.meta.env.VITE_SUPPORT_WHATSAPP || '5511986698398';
  const email = import.meta.env.VITE_SUPPORT_EMAIL || 'gustavoferreyra43@gmail.com';
    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
      <div className="w-full max-w-md text-center">
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 space-y-3">
          <a
            href={`https://wa.me/${whatsapp}?text=Ol%C3%A1%2C%20quero%20ativar%20minha%20assinatura%20do%20Agendy`}
            target="_blank"
          ...
          <a
            href={`mailto:${email}?subject=Quero%20ativar%20minha%20assinatura`}
