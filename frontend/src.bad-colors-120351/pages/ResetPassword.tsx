  ...
  return (
    <>
      ...
      <div className="min-h-screen flex">
          ...
          <div className="w-full max-w-md">
            ...
            {success ? (
              <div className="text-center py-6 animate-fade-in-up">
                ...
                <Link
                  to="/login"
                  className="inline-block bg-violet-300 text-white px-6 py-2.5 rounded-lg font-semibold hover:bg-violet-300"
                >
                  Ir para o login
                </Link>
              </div>
              ...
              <>
                ...
                <form onSubmit={handleSubmit} className="space-y-4 md:space-y-5 animate-fade-in-up delay-200">
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full pl-10 pr-12 py-3 border border-gray-300 rounded-lg text-sm md:text-base text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-violet-300 focus:border-transparent transition"
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className={`w-full pl-10 pr-12 py-3 border rounded-lg text-sm md:text-base text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-violet-300 focus:border-transparent transition ${confirmPassword.length > 0 && confirmPassword !== password
                            ? 'border-red-300'
                            : 'border-gray-300'
                          }`}
                  ...
                  <button
                    ...
                    className="w-full bg-violet-300 text-white py-3 rounded-lg font-semibold hover:bg-violet-300 focus:outline-none focus:ring-2 focus:ring-violet-300 focus:ring-offset-2 disabled:opacity-60 disabled:cursor-not-allowed transition flex items-center justify-center gap-2"
                  >
                    {loading ? (
                      <>
                ...
                <p className="text-center text-sm text-gray-600 mt-6 md:mt-8 animate-fade-in delay-300">
                  <Link to="/login" className="inline-flex items-center gap-1 text-violet-300 font-medium hover:underline">
        ...
        <div className="hidden lg:flex lg:flex-1 bg-gradient-to-br from-violet-300 to-violet-300 p-12 items-center justify-center relative overflow-hidden animate-fade-in">
          <div className="absolute top-0 right-0 w-96 h-96 bg-violet-300 rounded-full -mr-32 -mt-32 opacity-20" />
          <div className="absolute bottom-0 left-0 w-80 h-80 bg-violet-300 rounded-full -ml-24 -mb-24 opacity-20" />
