...
export default function Appointments() {
  ...
  const statusColor = (status: string) => {
    switch (status) {
      ...
      case 'completed':
        return 'bg-violet-100 text-violet-300';
      case 'pending':
      default:
          ...
          <div>
            ...
            <div className="relative">
              ...
              <select
                ...
                className="w-full pl-9 pr-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-violet-300 focus:border-transparent transition bg-white"
              >
