      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-4 md:p-6 mb-4 md:mb-6 animate-fade-in-up delay-100">
        ...
        <form onSubmit={handleCreate}>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <select
                  ...
                  className="w-full pl-9 pr-3 py-2.5 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-violet-300 focus:border-transparent transition bg-white"
                  required
                >
          ...
          <button
            type="submit"
            disabled={saving}
            className="inline-flex items-center justify-center gap-2 bg-violet-300 text-white px-4 py-2.5 rounded-lg font-medium hover:bg-violet-300 disabled:opacity-60 disabled:cursor-not-allowed transition w-full md:w-auto"
          >
            {saving ? (
              <>
            ...
            {associations.map((a, index) => (
              ...
              >
                <div className="flex items-start gap-3">
                  <div className="w-10 h-10 rounded-full bg-violet-100 flex items-center justify-center text-violet-300 text-sm font-semibold flex-shrink-0">
                    {a.professional?.name?.[0]?.toUpperCase() || 'P'}
                  </div>
