  ...
  return (
    <div className="p-4 md:p-8">
      ...
      <div className="mb-6 md:mb-8 animate-fade-in-up">
        <Link
          to="/admin/schedules"
          className="inline-flex items-center gap-1 text-sm text-gray-600 hover:text-violet-300 mb-3"
        >
            ...
            <div>
              ...
              <div className="relative">
                ...
                <select
                  ...
                  className="w-full pl-9 pr-3 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-violet-300 focus:border-transparent transition bg-white"
                  required
                >
