          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 md:p-8 text-center animate-fade-in-up">
            ...
            {status === 'success' && (
              <>
                ...
                <Link
                  to="/login"
                  className="inline-block w-full bg-violet-300 text-white py-3 rounded-lg font-semibold hover:bg-violet-300 transition"
                >
                  Ir para o login
                </Link>
              </>
            ...
            {status === 'error' && (
              <>
                ...
                <div className="space-y-3">
                  <Link
                    to="/cadastro"
                    className="inline-flex items-center justify-center gap-2 w-full bg-violet-300 text-white py-3 rounded-lg font-semibold hover:bg-violet-300 transition"
                  >
