        ...
        <div className="space-y-8 text-sm leading-relaxed">
          <section>
            ...
            <p>
              ...
              na plataforma <strong>AgendaApp</strong>, em conformidade com a Lei Geral de
          ...
          <section>
            ...
            <p className="mt-2">
              ...
              como <strong>Controlador</strong> e o AgendaApp atua como <strong>Operador</strong>. Nesse caso:
            </p>
            <ul className="list-disc pl-5 mt-2 space-y-1">
              ...
              <li>O AgendaApp tratará tais dados apenas conforme instruções do Usuário.</li>
            </ul>
          </section>
