            ...
            {success ? (
              <div className="text-center py-6 animate-fade-in">
                <div className="w-16 h-16 md:w-20 md:h-20 rounded-full bg-violet-100 flex items-center justify-center mx-auto mb-5">
                  <Mail className="w-8 h-8 md:w-10 md:h-10 text-violet-600" />
                </div>
                ...
                <div className="bg-violet-50 border border-violet-100 rounded-lg px-4 py-3 text-left mb-5">
                  <p className="text-xs text-violet-900 leading-relaxed font-semibold mb-1">
                    Próximos passos:
                  </p>
                  <ol className="text-xs text-violet-900 leading-relaxed list-decimal list-inside space-y-0.5">
                ...
                <Link
                  to="/login"
                  className="inline-block w-full bg-violet-600 text-white px-6 py-3 rounded-lg font-semibold hover:bg-violet-700 transition"
                >
                  Ir para o login
                </Link>
              </div>
              ...
              <>
                {plan !== 'basico' && (
                  <div className="mb-4 bg-violet-50 border border-violet-100 rounded-lg px-4 py-3 flex items-start gap-2">
                    <svg className="w-5 h-5 flex-shrink-0 mt-0.5 text-violet-600" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                    </svg>
                    <p className="text-xs md:text-sm text-violet-900">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full pl-9 pr-3 py-2.5 border border-gray-300 rounded-lg text-sm md:text-base focus:outline-none focus:ring-2 focus:ring-violet-500 focus:border-transparent transition"
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full pl-9 pr-12 py-2.5 border border-gray-300 rounded-lg text-sm md:text-base focus:outline-none focus:ring-2 focus:ring-violet-500 focus:border-transparent transition"
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className={`w-full pl-9 pr-12 py-2.5 border rounded-lg text-sm md:text-base focus:outline-none focus:ring-2 focus:ring-violet-500 focus:border-transparent transition ${confirmPassword.length > 0 && confirmPassword !== password
                          ? 'border-red-300'
                          : 'border-gray-300'
                          }`}
                  ...
                  <div>
                    ...
                    <div className="flex items-center border border-gray-300 rounded-lg overflow-hidden focus-within:ring-2 focus-within:ring-violet-500 focus-within:border-transparent transition">
                  ...
                  <button
                    type="submit"
                    disabled={loading}
                    className="w-full bg-violet-600 text-white py-3 rounded-lg font-semibold hover:bg-violet-700 disabled:opacity-50 disabled:cursor-not-allowed transition flex items-center justify-center gap-2"
                  >
                    {loading ? (
                      <>
                  ...
                  <p className="text-xs text-gray-500 text-center leading-relaxed">
                    ...
                    <Link to="/termos" className="text-violet-600 hover:underline">
                      Termos de Uso
                    </Link>{' '}
                    e nossa{' '}
                    <Link to="/privacidade" className="text-violet-600 hover:underline">
